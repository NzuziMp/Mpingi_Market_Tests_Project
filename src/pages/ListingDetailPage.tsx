...
import { MapPin, Clock, Eye, Heart, Share2, Flag, ChevronLeft, ChevronRight, Tag, User, Phone, Mail, MessageCircle, Shield, CheckCircle } from 'lucide-react';
...
export default function ListingDetailPage({ listingId, onNavigate }: ListingDetailPageProps) {
  ...
  useEffect(() => {
    async function load() {
      ...
      if ((data as any).categories) setCategory((data as any).categories as Category);
